...
func (fake *FakeVmrunRunner) Suspend(arg1 string) error {
	...
	if fake.SuspendStub != nil {
		return fake.SuspendStub(arg1)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeVmrunRunner) SuspendCallCount() int {
	fake.suspendMutex.RLock()
	defer fake.suspendMutex.RUnlock()
	return len(fake.suspendArgsForCall)
}

func (fake *FakeVmrunRunner) SuspendCalls(stub func(string) error) {
	fake.suspendMutex.Lock()
	defer fake.suspendMutex.Unlock()
	fake.SuspendStub = stub
}

func (fake *FakeVmrunRunner) SuspendArgsForCall(i int) string {
	fake.suspendMutex.RLock()
	defer fake.suspendMutex.RUnlock()
...
func (fake *FakeVmrunRunner) SuspendReturns(result1 error) {
	fake.suspendMutex.Lock()
	defer fake.suspendMutex.Unlock()
...
func (fake *FakeVmrunRunner) SuspendReturnsOnCall(i int, result1 error) {
	fake.suspendMutex.Lock()
	defer fake.suspendMutex.Unlock()
	fake.SuspendStub = nil
